                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                  onTap: () {
                                    selectedOption(itemXx[i].a, itemXx[i].ca, i,
                                        itemXx[i].no);
                                  },
                                  child: Container(
                                      height: 35,
                              ...
                              GestureDetector(
                                  onTap: () {
                                    selectedOption(itemXx[i].b, itemXx[i].ca, i,
                                        itemXx[i].no);
                                  },
                                  child: Container(
                                      height: 35,
                              ...
                              GestureDetector(
                                  onTap: () {
                                    selectedOption(itemXx[i].c, itemXx[i].ca, i,
                                        itemXx[i].no);
                                  },
                                  child: Container(
                                      height: 35,
                              ...
                              GestureDetector(
                                  onTap: () {
                                    selectedOption(itemXx[i].d, itemXx[i].ca, i,
                                        itemXx[i].no);
                                  },
                                  child: Container(
                                      height: 35,
